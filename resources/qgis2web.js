...
map.getView().fit([1028013.605770, 6613065.507315, 1071957.262610, 6641720.859356], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Homberg 01</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (77 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Gesamtumsätze (€) im Umkreis von 500 m von potenziellen Car-Sharing Stationen';
            }
